    ...
    for (let attempt = 1; attempt <= maxRetries; attempt++) {
        try {
            ...
            try {
                ...
                console.log(`\x1b[33m[ \x1b[37mWIT KOEI \x1b[33m] \x1b[35m• \x1b[36mĐiểm danh Acc \x1b[33m${accountNumber} \x1b[35m hôm nay thành công ${YELLOW }...`);
            } catch (err) {
                console.log(`\x1b[33m[ \x1b[37mWIT KOEI \x1b[33m] \x1b[35m• \x1b[31mAcc \x1b[33m${accountNumber} \x1b[31m hôm nay điểm danh rồi`);
            }

            const successclaimButtonSelector = 'body > div.ease.fixed.bottom-0.left-0.z-\\[1000\\].max-h-\\[100svh\\].w-full.transform.rounded-\\[10px_10px_0_0\\].bg-dark-second.p-4.pb-8.transition-\\[transform\\].duration-500.translate-y-\\[0\\%\\].animate-move200 > div > div:nth-child(2) > div > div > button';
            try {
                await page.waitForSelector(successclaimButtonSelector, { timeout: 3000 });
                await page.click(successclaimButtonSelector);
                console.log(`\x1b[33m[ \x1b[37mWIT KOEI \x1b[33m] \x1b[35m• \x1b[36mĐiểm danh Acc \x1b[33m${accountNumber} \x1b[35m hôm nay thành công ${YELLOW }...`);
            } catch (err) {
                console.log(`\x1b[33m[ \x1b[37mWIT KOEI \x1b[33m] \x1b[35m• \x1b[31mAcc \x1b[33m${accountNumber} \x1b[31m hôm nay điểm danh rồi`);
            }
